...
- 文本对比工具：双栏文本导入、行级差异、词级高亮、空白规范化和 Unified Diff 导出
- 字数统计工具：统计字符、单词、段落、频率，并支持 txt/md/json/csv/log/doc/docx 导入、文本清洗、重复行诊断和多格式导出
...
- 日志分析工具：日志级别统计、过滤搜索、JSON/CSV字段筛选、状态码/IP/接口/异常洞察
